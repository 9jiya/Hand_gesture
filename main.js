...
function speak(){
    ...
    speak_data1 = "The first Identification is"+Identification1;
    speak_data2 = "And The second Identification is"+Identification2;
    var g = new SpeechSynthesisUtterance(speak_data1+speak_data2);
    synth.speak(g);
}
function check(){
...
function  gotResult(error,results){
    if(error){
        ...
        Identification1 = results[0].label;
        Identification2 = results[1].label;
        speak();
